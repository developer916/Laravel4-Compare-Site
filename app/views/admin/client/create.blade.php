		...
		<h3 class="page-title">Add Profession Management</h3>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.client.create')}}">Add What our clients say</a>
					</li>
				</ul>
			</div>
			<div class="row">
							...
							<form  class="form-horizontal" id="addClientForm" method="POST" action="{{URL::route('admin.client.store')}}">
								<div class="form-body">
									<div class= "form-group">
										<label for="inputEmail1" class="col-md-3 control-label">User Name</label>
										<div class="col-md-7">
					                         <select  class="form-control" name="subName" id="subName">
					                         	<option value=""></option>
					                         	<?php for($i=0; $i<count($userNames); $i++) {?>
					                         		<option value ="<?php echo $userNames[$i]->id?>"><?php echo $userNames[$i]->UserName?></option>	
					                         	<?php }?>
					                         </select>
					                    </div>
					                 </div>
					                 <div class= "form-group">
										<label for="inputEmail1" class="col-md-3 control-label">Body</label>
										<div class="col-md-7">
