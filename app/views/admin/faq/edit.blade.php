		...
		<h3 class="page-title">Edit Profession Management</h3>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.faq.create')}}">Edit Faq</a>
					</li>
				</ul>
			</div>
			<div class="row">
							 	 ...
							 	 <div class="form-body">
							             ...
							             <div class="form-group">
              								  ...
              								  <div class="col-md-7">
							                     ...
							                     @elseif($key==='Question')
							                    	 <textarea rows="2" class="form-control" name="subName" id="subName" placeholder="Sub Name" style="height:150px">{{ $client->{$key} }}</textarea>
